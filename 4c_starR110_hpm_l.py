...
for n in range(num_step):
    ...
    if n in [0,8,16,24,32,40,48,56,64,72,80,88,96,104,112,120,128,136,144,152,160,320,480,640,800,960,1120,1280,1440,1600,3200,4800,6400,8000,9999]:
        ...
        vtkfile_glc = File('results_4c_starR110_hpm_l/glc/glc_starR110_hpm_l_%sof10000.pvd' % n)
        vtkfile_atp = File('results_4c_starR110_hpm_l/atp/atp_starR110_hpm_l_%sof10000.pvd' % n)
        vtkfile_adp = File('results_4c_starR110_hpm_l/adp/adp_starR110_hpm_l_%sof10000.pvd' % n)
        vtkfile_gly = File('results_4c_starR110_hpm_l/gly/gly_starR110_hpm_l_%sof10000.pvd' % n)
        vtkfile_pyr = File('results_4c_starR110_hpm_l/pyr/pyr_starR110_hpm_l_%sof10000.pvd' % n)
        vtkfile_lac = File('results_4c_starR110_hpm_l/lac/lac_starR110_hpm_l_%sof10000.pvd' % n)
